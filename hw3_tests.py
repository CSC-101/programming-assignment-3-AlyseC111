...
california = [data.CountyDemographics(
...
class TestCases(unittest.TestCase):
    ...
    def test_population_total_1(self):
        expected = 318857056
        actual = hw3.population_total(full_data)
        self.assertEqual(expected, actual)
    def test_population_total_2(self):
        expected = 655813
        actual = hw3.population_total(reduced_data)
        self.assertEqual(expected, actual)
    ...
    def test_filter_by_state_1(self):
        expected = 38802500
        actual = hw3.population_total(hw3.filter_by_state(full_data, 'CA'))
        self.assertEqual(expected, actual)
    ...
    def test_population_by_education_1(self):
        expected = 87911.145
        actual = hw3.population_by_education([data.CountyDemographics({'Percent 65 and Older': 17.5, 'Percent Under 18 Years': 18.1, 'Percent Under 5 Years': 4.8},'San Luis Obispo County',{"Bachelor's Degree or Higher": 31.5, 'High School or Higher': 89.6},{'American Indian and Alaska Native Alone': 1.4,'Asian Alone': 3.8,'Black Alone': 2.2,'Hispanic or Latino': 22.0,'Native Hawaiian and Other Pacific Islander Alone': 0.2,'Two or More Races': 3.4,'White Alone': 89.0,'White Alone, not Hispanic or Latino': 69.5},{'Median Household Income': 58697,'Per Capita Income': 29954,'Persons Below Poverty Level': 14.3},{'2010 Population': 269637,'2014 Population': 279083,'Population Percent Change': 3.5,'Population per Square Mile': 81.7},'CA')], "Bachelor's Degree or Higher")
        self.assertEqual(expected, actual)
    def test_population_by_education_2(self):
        expected = 195114.091
        actual = hw3.population_by_education(reduced_data, "Bachelor's Degree or Higher")
        self.assertEqual(expected, actual)
    # test population_by_ethnicity
    def test_population_by_ethnicity_1(self):
        expected = 405944.680
        actual = hw3.population_by_ethnicity(california, "White Alone")
        self.assertEqual(expected, actual)
    def test_population_by_ethnicity_2(self):
        expected = 0
        actual = hw3.population_by_ethnicity(california, "Filipino")
        self.assertEqual(expected, actual)
    # test population_below_poverty_level
    def test_population_below_poverty_level_1(self):
        expected =  79558.559
        actual = hw3.population_below_poverty_level(california)
        self.assertEqual(expected, actual)
    def test_population_below_poverty_level_2(self):
        expected =  107711.714
        actual = hw3.population_below_poverty_level(reduced_data)
        self.assertEqual(expected, actual)
    ...
    def test_percent_by_education_1(self):
        expected = 0.342
        actual = hw3.percent_by_education(california, "Bachelor's Degree or Higher")
        self.assertEqual(expected, actual)
    def test_percent_by_education_2(self):
        expected = 0.864
        actual = hw3.percent_by_education(reduced_data, "High School or Higher")
        self.assertEqual(expected, actual)
    # test percent_by_ethnicity
    def test_percent_by_ethnicity_1(self):
        expected = 0.845
        actual = hw3.percent_by_ethnicity(reduced_data, "White Alone")
        self.assertEqual(expected, actual)
    def test_percent_by_ethnicity_2(self):
        expected = 0.025
        actual = hw3.percent_by_ethnicity(california, "Black Alone")
        self.assertEqual(expected, actual)
    # test percent_below_poverty_level
    def test_percent_below_poverty_level_1(self):
        expected = 0.164
        actual = hw3.percent_below_poverty_level(reduced_data)
        self.assertEqual(expected, actual)
    ...
    def test_education_greater_than_1(self):
        expected = california
        actual = hw3.education_greater_than(california, 'High School or Higher', 50)
        self.assertEqual(expected, actual)
    def test_education_greater_than_2(self):
        expected = california
        actual = hw3.education_greater_than(reduced_data, "Bachelor's Degree or Higher", 30)
        self.assertEqual(expected, actual)
    ...
    data.CountyDemographics(
        ...
        {'2010 Population': 7208,
         ...
         'Population per Square Mile': 3.0},
        'WY')]
        actual = hw3.education_less_than(reduced_data, "Bachelor's Degree or Higher", 20)
        self.assertEqual(expected, actual)
    ...
    def test_education_less_than_2(self):
        ...
        {'2010 Population': 269637,
         ...
         'Population per Square Mile': 81.7},
        'CA')]
        actual = hw3.education_less_than(california, "Bachelor's Degree or Higher", 35)
        self.assertEqual(expected, actual)
    # test ethnicity_greater_than
    def test_ethnicity_greater_than_1(self):
        expected = california
        actual = hw3.ethnicity_greater_than(reduced_data, "Hispanic or Latino", 10)
        self.assertEqual(expected, actual)
    def test_ethnicity_greater_than_2(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        actual = hw3.ethnicity_greater_than(california, "Hispanic or Latino", 30)
        self.assertEqual(expected, actual)
    ...
    def test_ethnicity_less_than_1(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        actual = hw3.ethnicity_less_than(reduced_data, "White Alone", 85)
        self.assertEqual(expected, actual)
    ...
    def test_ethnicity_less_than_2(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        actual = hw3.ethnicity_less_than(california, "White Alone", 80)
        self.assertEqual(expected, actual)
    ...
    def test_below_poverty_level_greater_than_1(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        actual = hw3.below_poverty_level_greater_than(california, 15)
        self.assertEqual(expected, actual)
    ...
    def test_below_poverty_level_less_than_1(self):
        ...
        {'2010 Population': 269637,
         ...
         'Population per Square Mile': 81.7},
        'CA')]
        actual = hw3.below_poverty_level_less_than(california, 15)
        self.assertEqual(expected, actual)
    def test_below_poverty_level_less_than_2(self):
        ...
        {'2010 Population': 7208,
         ...
         'Population per Square Mile': 3.0},
        'WY')]
        actual = hw3.below_poverty_level_less_than(reduced_data, 15)
        self.assertEqual(expected, actual)
